...
def start(update, context):
    ...
    update.message.reply_text("Hi!/n I'm the demo weather bot, just send me the name of a city and i'll provide you with the curent temperature there" )
...
def weather(update, context):
    ...
    # API Call End
    update.message.reply_text("The temperature at " + str(update.message.text) + ' is ' + str(temperature) + degree_sign + 'C')
